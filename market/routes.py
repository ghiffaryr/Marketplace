    ...
    if request.method == "POST":
        ...
        if p_item_object:
            if current_user.can_purchase(p_item_object):
                ...
                flash(f'Congratulations! You purchased {p_item_object.name} for {p_item_object.price_display}$', category='success')
            else:
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f'Congratulations! {s_item_object.name} have been sold for {s_item_object.price_display}', category='success')
            else:
